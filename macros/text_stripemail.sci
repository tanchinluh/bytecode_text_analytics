function out_str = text_stripemail(in_str, rep_str)
    ...
    //
    // Examples
    //    in_str = 'Our website address is tina@bytecode-asia.com';
    //    out_str = text_stripemail(in_str);
    //    disp(out_str);
    //
    // See also
    //    nlp_sentiment
...
if rhs < 2; rep_str = 'emailaddr'; end
//Initializing Weight and Bias
if rep_str == []; rep_str = 'emailaddr'; end


out_str = strsubst(in_str, '/[^\s]+@[^\s]+/', rep_str,'r');    
