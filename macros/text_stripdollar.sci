function out_str = text_stripdollar(in_str, rep_str)
    ...
    //
    // Examples
    //    in_str = 'This item cost $100';
    //    out_str = text_stripdollar(in_str);
    //    disp(out_str);
    //
    // See also
    //    nlp_sentiment
...
if rhs < 2; rep_str = 'dollar'; end
//Initializing Weight and Bias
if rep_str == []; rep_str = 'dollar'; end
